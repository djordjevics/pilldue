...
**v1:** monthly refill day from prescription start, package-based stock, prescription end ~6 months, skip-dose stock bump, calendar. See [use cases](docs/use-cases.md).
