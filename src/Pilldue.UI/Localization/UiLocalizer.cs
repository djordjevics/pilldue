...
public static class UiLocalizer
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["Cal.RestockNote"] = "Stock-out days assume the usual prescribed packages are obtained at the first refill.",
    ...
    private static readonly Dictionary<string, string> Serbian = new()
    {
        ...
        ["Cal.RestockNote"] = "Dani bez zalihe pretpostavljaju uobicajena pakovanja na prvoj dopuni.",
