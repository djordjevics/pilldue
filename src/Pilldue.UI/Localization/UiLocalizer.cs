...
public static class UiLocalizer
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["Med.RxStart"] = "Prescription start date (yyyy-MM-dd; day-of-month is this med's refill day):",
        ...
        ["Refill.Confirm"] = "Confirm refill of {0}: {1} package(s) today?",
    ...
    private static readonly Dictionary<string, string> Serbian = new()
    {
        ...
        ["Med.RxStart"] = "Pocetak recepta (yyyy-MM-dd; dan u mesecu je dan dopune ovog leka):",
        ...
        ["Refill.Confirm"] = "Potvrditi dopunu {0}: {1} pakovanje/a danas?",
